...
import com.hhy.zxing.ScanListener;
import com.hhy.zxing.ScanManager;
import com.hhy.zxing.decode.DecodeThread;
import com.hhy.zxing.decode.Utils;
...
//        tv_scan_result.setText("结果："+rawResult.getText());
    ...
    private void getResult(String result){
        if (TextUtils.isEmpty(result)) {
            Toast.makeText(CommonScanActivity.this, "不能为空", Toast.LENGTH_LONG);
            return;
        }
        Intent resultIntent = new Intent();
        resultIntent.putExtra(ScanActivity.TAG_RESULT, result);
        setResult(ScanActivity.RESULT_CODE, resultIntent);
...
//                showPictures(PHOTOREQUESTCODE);
                final EditText editText = new EditText(CommonScanActivity.this);
                editText.setHint("请输入内容");
                new AlertDialog.Builder(CommonScanActivity.this)
                        .setView(editText)
